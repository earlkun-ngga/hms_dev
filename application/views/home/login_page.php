				...
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('<?= base_url(); ?>assets/media/bg/bg-3.jpg');">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							<div class="mb-20">
								<h3>K-HMS | Hospital Management System</h3>
								<div class="text-muted font-weight-bold">Login to Admin Page</div>
							</div>
							<form method="post" action="<?= base_url(); ?>home/proses_login" >
								...
								<input type="submit" value="Log In" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4"/>
							</form>
							<div class="mt-10">
