			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('<?= base_url(); ?>assets/media/users/tester.jpg')"></div>
						<i class="symbol-badge bg-success"></i>
					</div>
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?= $_SESSION['userdata']['fullname']; ?></a>
						<div class="text-muted mt-1">@<?= $_SESSION['userdata']['username']; ?></div>
						<div class="navi mt-2">
							<a href="#" class="navi-item">
								
							</a>
							<a href="<?= base_url(); ?>Home/proses_logout" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Logout</a>
						</div>
					</div>
				</div>
				<!--end::Header-->
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
						<!--begin::Logo-->
						<a href="index.html">
							<img alt="Logo" src="<?= base_url(); ?>assets/media/logos/logo-letter-12.png" class="max-h-30px" />
						</a>
						<!--end::Logo-->
						<!--begin::Toolbar-->
							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<a href="index.html" class="mr-20">
										<img alt="Logo" src="<?= base_url(); ?>assets/media/logos/logo-letter-12.png" class="max-h-40px" />
									</a>
									<!--end::Logo-->
								</div>
								<!--end::Left-->
						...
						<div class="header-bottom" id="kt_header_bottom">
							...
							<div class="container d-flex flex-column">
								...
								<ul class="header-tabs nav flex-column-auto" role="tablist">
									<!--begin::Item-->
									<li class="nav-item">
										<a href="<?= base_url(); ?>admin" class="nav-link <?= ($big == '1') ? 'active' : ''; ?>">
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="nav-item" id="clinic_head">
										<a href="<?= base_url(); ?>admin/active_medical" class="nav-link <?= ($big == '3') ? 'active' : ''; ?>">
											<span class="nav-title text-uppercase">CLINIC</span>
									...
									<!--begin::Item-->
									<li class="nav-item">
										<a href="<?= base_url(); ?>admin/accounting_payment" class="nav-link <?= ($big == '4') ? 'active' : ''; ?>">
									...
									<!--begin::Item-->
									<li class="nav-item">
										<a href="<?= base_url(); ?>admin/patient_manage_page" class="nav-link <?= ($big == '5') ? 'active' : ''; ?>" >
								...
								<div class="header-navs header-navs-left flex-column-fluid" id="kt_header_navs">
									...
									<div class="tab-content">
										<!--begin::Tab Pane-->
										<div class="tab-pane <?= ($big == '1') ? 'show active' : ''; ?>" id="kt_header_tab_1">
											<!--begin::Menu-->
										...
										<div class="tab-pane justify-content-between px-4 px-lg-0 <?= ($big == '3') ? 'show active' : ''; ?>" id="kt_header_tab_3">
											<div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center">
												<!--begin::Actions-->
												...
												<div class="dropdown mr-3 my-2 my-lg-0">
												    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
												        <b>Items Clinic</b>
												    </button>
												    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												        <a class="dropdown-item" href="<?= base_url(); ?>Admin/drugs">Drugs</a>
												        <a class="dropdown-item" href="#">Equipments</a>
												        <a class="dropdown-item" href="#">Import</a>
												        <a class="dropdown-item" href="#">Conditions Drugs/Equipments</a>
												    </div>
												</div>
												
												<a href="#" class="btn btn-light font-weight-bold mr-3 my-2 my-lg-0">Payment</a>
										...
										<div class="tab-pane justify-content-between px-4 px-lg-0 <?= ($big == '4') ? 'show active' : ''; ?>" id="kt_header_tab_4">
											<div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center">
												<!--begin::Actions-->
												<a href="#" class="btn btn-light font-weight-bold mr-3 my-2 my-lg-0">Income</a>
												
												<!--end::Actions-->
											</div>
											<div class="d-flex align-items-center">
												<!--begin::Actions-->
												<a href="#" class="btn btn-dark font-weight-bold my-2 my-lg-0">REPORT</a>
												<!--end::Actions-->
											</div>
										</div>

										<div class="tab-pane justify-content-between px-4 px-lg-0 <?= ($big == '5') ? 'show active' : ''; ?>" id="kt_header_tab_5">
											<div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center">
												<!--begin::Actions-->
